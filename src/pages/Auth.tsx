      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">
            {language === 'en' ? 'AI Arabic Dictionary' : 'قاموس الذكاء الاصطناعي العربي'}
          </h1>
        </div>
        ...
        <Card className="shadow-xl border-blue-200">
          <CardHeader className="space-y-1 text-center">
            ...
            <p className="text-slate-600">
              {isLogin 
                ? (language === 'en' ? 'Enter your credentials to access the admin panel' : 'أدخل بياناتك للوصول إلى لوحة الإدارة')
          ...
          <CardContent>
            ...
            <div className="mt-4 text-center">
              ...
              >
                {isLogin 
                  ? (language === 'en' ? "Don't have an account? Sign up" : 'لا تملك حسابًا؟ سجل الآن')
                  : (language === 'en' ? 'Already have an account? Sign in' : 'لديك حساب بالفعل؟ سجل الدخول')
                }
              </Button>
            </div>
          </CardContent>
